...
$string['discussionlistsortedbycreatedasc'] = 'The discussions list table is sorted by the creation date in ascending order';
$string['discussionlistsortedbycreateddesc'] = 'The discussions list table is sorted by the creation date in descending order';
$string['discussionlistsortedbylastpostasc'] = 'The discussions list table is sorted by the creation date of the last post in ascending order';
$string['discussionlistsortedbylastpostdesc'] = 'The discussions list table is sorted by the creation date of the last post in descending order';
$string['discussionlistsortedbyrepliesasc'] = 'The discussions list table is sorted by the number of replies in ascending order';
$string['discussionlistsortedbyrepliesdesc'] = 'The discussions list table is sorted by the number of replies in descending order';
