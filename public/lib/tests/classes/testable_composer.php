...
class testable_composer extends \core\composer {
    /** @var array The installed packages with version. */
     ...
     * @return void
     */
    public function set_installed_packages(array $installedpackages): void {
    ...
    protected function get_installed_package_version(string $package): ?string {
        return $this->installedpackages[$package] ?? null;
    }
}
