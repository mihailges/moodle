 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class toc_none_renderer extends renderer_base {

    /** @var string $template The template to render */
    protected $template = 'mod_book/book_table_of_contents_none';

    /**
     * Constructor.
     *
     * @param toc_none_builder $builder The book chapters
     */
    public function __construct(toc_none_builder $builder) {
