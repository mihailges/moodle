...
define(
    ...
    var SELECTORS = {
        MODULE_CHOOSER_CONTAINER: '.modal-body .modchoosercontainer',
    ...
    var registerListenerEvents = function() {
        ...
        thisevent = $(SELECTORS.MODULE_AREA).on('keydown', function(e) {
            ...
            var optionOuterWidth = $(SELECTORS.MODULE_CHOOSER_CONTAINER + " " +  SELECTORS.MODULE_AREA).outerWidth();
            console.log(optionOuterWidth);
            var wrapperWidth = $(SELECTORS.MODULE_CHOOSER_CONTAINER + " " +  SELECTORS.MODULES_AREA).width();
            console.log(wrapperWidth);
            var rowOptions = Math.floor(wrapperWidth / optionOuterWidth);
            console.log(rowOptions);
            var modules = $(SELECTORS.MODULE_CHOOSER_CONTAINER + " " +  SELECTORS.MODULES_AREA).find(SELECTORS.MODULE_AREA);
