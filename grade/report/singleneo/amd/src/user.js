 ...
 *
 * @module    gradereport_singleneo/user
...
const registerListenerEvents = () => {
        ...
        document.addEventListener(event, async(e) => {
            ...
            if (trigger) {
                ...
                WidgetBase.init(
                    ...
                    data.users,
                    searchUsers(),
                    getString('pluginname', 'gradereport_singleneo')
                );
            }
        });
    });
    ...
    bodyPromiseResolver(Templates.render(
        'gradereport_singleneo/usersearch_body',
        []
    ));
    footerPromiseResolver(Templates.render(
        'gradereport_singleneo/usersearch_footer',
        []
    ));
};
