...
$string['scope_desc_admin_course_delete'] = 'Allows the application to permanently delete courses and course categories';
$string['scope_name_admin_course_read'] = 'View site-wide course configurations and category structures';
$string['scope_desc_admin_course_read'] = 'Allows the application to view global course defaults, system category structures, and read the entire course registry catalog across the site without making changes.';
$string['scope_name_admin_course_write'] = 'Manage site-wide course configurations and category structures';
$string['scope_desc_admin_course_write'] = 'Allows the application to create and modify courses and course categories, adjust site-wide course defaults.';
$string['scope_name_admin_user_read'] = 'View site-wide user accounts and profile data';
$string['scope_desc_admin_user_read'] = 'Allows the application to query, search, and view core user account details and account suspension states';
$string['scope_name_admin_user_write'] = 'Manage site-wide user accounts and profiles';
$string['scope_desc_admin_user_write'] = 'Allows the application to create new user accounts, update profile information, and manage suspension states across the system';
$string['scope_name_admin_user_delete'] = 'Delete site-wide user accounts';
$string['scope_desc_admin_user_delete'] = 'Allows the application to permanently delete user accounts, and trigger privacy data purges across the entire system.';
