...
/**
 * Grade penalty exemption deleted event class.
 *
 * @package    core
 * @since      Moodle 5.1
 ...
 */
class grade_penalty_exemption_deleted extends base {
    ...
    public static function get_name() {
        return get_string('eventgradeexemptiondeleted', 'core_grades');
    }
    ...
    public function get_description() {
        return "The user with id '{$this->userid}'" .
            " deleted the grade penalty exemption with id '{$this->objectid}'" .
