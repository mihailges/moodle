...
/**
 * Strings for component 'gradereport_user41', language 'en'
 *
...
$string['eventgradereportviewed'] = 'Grade user41 report viewed';
$string['pluginname'] = 'Neo User report';
$string['user41:view'] = 'View your own grade report';
$string['myself'] = 'Myself';
$string['otheruser'] = 'User';
$string['privacy:metadata:preference:gradereport_user41_view_user'] = 'Whether to view report as current user or another user in the gradebook reports';
