    ...
    protected function add_columns(): void {
        ...
        $this->add_column((new column(
            ...
            ->add_callback(function ($value, \stdClass $row) {
                ...
                if ($isrevoked) {
                    $statusstring = get_string('oauth2server_clientstatusrevoked', 'admin');
                    $badgetype = 'danger';
                } else if ($isexpired) {
                    $statusstring = get_string('oauth2server_clientstatusexpired', 'admin');
                    $badgetype = 'danger';
                } else {
                    $statusstring = get_string('oauth2server_clientstatusactive', 'admin');
                    $badgetype = 'success';
                }
