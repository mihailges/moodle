...
class core_badges_privacy_testcase extends provider_testcase {
    ...
    public function test_delete_data_for_users() {
        ...
        $approvedlist = new approved_userlist($usercontext2, $component, $userlist1->get_userids());
        // Delete using delete_data_for_user. The data for users in usercontext2 should be removed.
