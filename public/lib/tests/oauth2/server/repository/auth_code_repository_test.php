...
final class auth_code_repository_test extends \advanced_testcase {
    ...
    public function test_persist_new_auth_code(): void {
        ...
        $code->setUserIdentifier('123'); // User ID 123
        $code->addScope($scope);
        ...
        $this->assertEquals($clientid, $record->clientidentifier);
    ...
    public function test_is_auth_code_revoked(): void {
        ...
        // If the code does not exist, it should be treated as revoked.
        $this->assertTrue($repository->isAuthCodeRevoked('non-existent-code'));
    }
}
