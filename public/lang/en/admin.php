...
$string['scope_admin_config_read_summary'] = 'Read site configuration';
$string['scope_admin_config_read_desc'] = 'Allows access to view site settings, plugin configurations, and system defaults.';
$string['scope_admin_config_write_summary'] = 'Manage site configuration';
$string['scope_admin_config_write_desc'] = 'Allows modifying site settings, plugin setups, and system integrations.';
$string['scope_admin_logs_read_summary'] = 'Read system logs';
$string['scope_admin_logs_read_desc'] = 'Allows access to site activity logs, user audit trails, and system event history.';
