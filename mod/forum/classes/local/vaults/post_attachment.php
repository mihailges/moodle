...
class post_attachment {
    /** @const string COMPONENT The component for attachments */
    private const COMPONENT = 'mod_forum';
    /** @const string FILE_AREA File area for attachments */
    private const FILE_AREA = 'attachment';
    /** @const string SORT Sort the attachments by filename */
    private const SORT = 'filename';
    /** @const bool INCLUDE_DIRECTORIES Don't include directories */
