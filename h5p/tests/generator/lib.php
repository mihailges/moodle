...
class core_h5p_generator extends component_generator_base {
    ...
    public function generate_h5p_data(bool $createlibraryfiles = false) : stdClass {
        ...
        if ($createlibraryfiles) {
            ...
            list($mainlibarr, $mainlibfiles) = $this->create_library($basedirectorymain, $mainlib->id, $mainlib->machinename,
                $mainlib->majorversion, $mainlib->minorversion);
            $filestorage->saveLibrary($mainlibarr);
            ...
            list($lib1arr, $lib1files) = $this->create_library($basedirectory1, $lib1->id, $lib1->machinename,
                $lib1->majorversion, $lib1->minorversion);
            $filestorage->saveLibrary($lib1arr);
            ...
            list($lib2arr, $lib2files) = $this->create_library($basedirectory2, $lib2->id, $lib2->machinename,
                $lib2->majorversion, $lib2->minorversion);
            $filestorage->saveLibrary($lib2arr);
            ...
            list($lib3arr, $lib3files) = $this->create_library($basedirectory3, $lib3->id, $lib3->machinename,
                $lib3->majorversion, $lib3->minorversion);
            $filestorage->saveLibrary($lib3arr);
            ...
            list($lib4arr, $lib4files) = $this->create_library($basedirectory4, $lib4->id, $lib4->machinename,
                $lib4->majorversion, $lib4->minorversion);
            $filestorage->saveLibrary($lib4arr);
            ...
            list($lib5arr, $lib5files) = $this->create_library($basedirectory5, $lib5->id, $lib5->machinename,
                $lib5->majorversion, $lib5->minorversion);
            $filestorage->saveLibrary($lib5arr);
        }
