 ...
 */
class import_key_manager_action_bar extends import_action_bar {
    ...
    public function export_for_template(\renderer_base $output): array {
        ...
        $importnavselectors = new import_action_bar($this->courseid,
            new moodle_url('/grade/import/keymanager.php', ['id' => $this->courseid]), 'keymanager');
        $data = $importnavselectors->export_for_template($output);

        // Add a button to the action bar with a link to the 'add user key' page.
        $adduserkeylink = new moodle_url('/grade/import/key.php', ['courseid' => $this->courseid]);
