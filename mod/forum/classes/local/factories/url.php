...
class url {
     ...
     * @param string|null $sortby The column to sort by
    ...
    public function get_forum_view_url_from_forum(forum_entity $forum, ?int $pageno = null,
                                                  ?string $sortby = null, ?int $sortorder = null) : moodle_url {
        return $this->get_forum_view_url_from_course_module_id($forum->get_course_module_record()->id, $pageno, $sortby, $sortorder);
    }
