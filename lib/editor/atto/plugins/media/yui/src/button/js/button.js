                ...
                '<div class="{{CSS.DISPLAY_OPTIONS}}">' +
                    '<div class="m-b-1">' +
                        ...
                        '<div class="form-inline {{CSS.POSTER_SIZE}}">' +
                            ...
                            '<input type="text" class="form-control m-l-1 {{CSS.HEIGHT_INPUT}} input-mini 1" size="4"/>' +
                        '</div>' +
                    '</div>' +
                    // Add the alignment selector.
                    '<div class="form-inline m-b-1">' +
                        '<label class="for="{{elementid}}_{{CSS.INPUTALIGNMENT}}">{{get_string "videoheight" component}}</label>' +
                        ...
                        // '{{/each}}' +
                            '<option value="{{value}}">dsadsadas</option>' +
                        '</select>' +
                    '</div>' +
