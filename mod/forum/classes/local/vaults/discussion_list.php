...
class discussion_list extends db_table_vault {
    /** @const string TABLE The table for this vault */
    private const TABLE = 'forum_discussions';
    /** @const string FIRST_AUTHOR_ID_ALIAS Alias for first author id */
    private const FIRST_AUTHOR_ID_ALIAS = 'userpictureid';
    /** @const string FIRST_AUTHOR_ALIAS Alias for author fields */
    private const FIRST_AUTHOR_ALIAS = 'userrecord';
    /** @const string LATEST_AUTHOR_ID_ALIAS Alias for last author id */
    ...
    /** @const int SORTORDER_OLDEST_FIRST Sort by oldest first */
