...
class core_course_externallib_testcase extends externallib_advanced_testcase {
     ...
     * @param string $expectedexception Expected exception string
     */
    public function test_get_enrolled_courses_by_timeline_classification(
        ...
        try {
            ...
            $this->assertEquals('Coding error detected, it must be fixed by a programmer: ' . $expectedexception, $e->getMessage());
        }
    }
