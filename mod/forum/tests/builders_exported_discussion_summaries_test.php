...
class builders_exported_discussion_summaries_testcase extends advanced_testcase {
     ...
     * @return array
     */
    private function convert_to_entities(stdClass $forum, array $discussions, array $posts) {
        global $DB;
        ...
        return [
            ...
            array_map(function($discussion) use ($entityfactory) {
                $discussion = $this->get_discussion_from_stdclass($discussion),
                $firstpost = $this->get_post_from_stdclass($firstpost, $firstpostauthorentity),
                $firstpostauthorentity,
            $this->get_author_from_stdclass($latestpostauthor)
                return $entityfactory->get_discussion_summary_from_stdclass($discussion, );
            }, $discussions),
            // Posts.
...
//        [$discussion2, $post2] = $this->helper_post_to_forum($forum2, $user);
//
//        [$forum, $discussions, $posts] = $this->convert_to_entities(
//            $forum,
//            [$discussion1, $discussion2],
//            [$post1, $post2]
//        );
...
//    }
     ...
     * given.
     */
    public function test_build_returns_discussions_in_order() {
        $this->resetAfterTest();
...
//        echo $course->id; die();
        ...
        list($discussion1, $post1) = $this->helper_post_to_forum($forum, $user1);
        list($discussion2, $post2) = $this->helper_post_to_forum($forum, $user2);
        ...
        list($forum, $discussions, $posts) = $this->convert_to_entities(
            $forum,
            [$discussion1, $discussion2],
        ...
        $exportedposts = $this->builder->build($user1, $forum, $discussions);
