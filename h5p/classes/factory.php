...
class factory {
    ...
    /** @var core $core The Moodle H5PCore implementation */
    protected $core;

    /** @var framework The Moodle H5PFramework implementation */
    protected $framework;

    /** @var storage The Moodle H5PStorage implementation */
    protected $storage;
    ...
    public function get_core() : core {
        if (null === $this->core) {
          ...
          $url = \moodle_url::make_pluginfile_url($context->id, 'core_h5p', 'core_h5p',
              null, '', '');
