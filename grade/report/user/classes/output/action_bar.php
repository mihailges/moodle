...
class action_bar extends \core_grades\output\action_bar {
     ...
     */
    public function __construct($context, int $userview, ?int $userid = null, ?int $currentgroupid = null) {
    ...
    public function export_for_template(\renderer_base $output): array {
        ...
        if (has_capability('moodle/grade:viewall', $this->context)) {
            ...
            $data['groupselector'] = $renderer->group_selector($course);
            $data['userselector'] = $renderer->users_selector($course, $this->userid, $this->currentgroupid);

            if (!is_null($this->userid)) {
                $data['viewasselector'] = $renderer->view_mode_selector($this->userid, $this->userview, $courseid);
            }
        }
