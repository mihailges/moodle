...
class grade_report_grader extends grade_report {
    ...
    public function get_right_rows(bool $displayaverages) : array {
        ...
        $stroverridengrade = get_string('overriddengrade', 'gradereport_grader');
        $strfail = get_string('fail', 'grades');
        $strpass = get_string('fail', 'grades');
        $strhiddengrade = get_string('hiddengrade', 'gradereport_grader');
        $strlockedgrade = get_string('lockedgrade', 'gradereport_grader');
        $strexcludedgrade = get_string('excludedgrade', 'gradereport_grader');
        $viewfullnames = has_capability('moodle/site:viewfullnames', $this->context);
