...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configcheckbox('block_online_users_setvisibility',
            get_string('setvisibility', 'block_online_users'),
            get_string('configsetvisibility', 'block_online_users'), 1));
}
