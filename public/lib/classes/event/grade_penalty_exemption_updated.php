...
/**
 * Grade penalty exemption updated event class.
 *
 * @package    core
 * @since      Moodle 5.1
 ...
 */
class grade_penalty_exemption_updated extends base {
    ...
    public static function get_name() {
        return get_string('eventgradeexemptionupdated', 'core_grades');
    }
    ...
    public function get_description() {
        return "The user with id '{$this->userid}'" .
            " updated the grade penalty exemption with id '{$this->objectid}'" .
