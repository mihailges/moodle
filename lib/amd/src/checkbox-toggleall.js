...
define(['jquery', 'core/pubsub'], function($, PubSub) {
    ...
    /**
     * Returns an array containing every toggle group level of a certain toggle group.
     *
     * @param {String} toggleGroupName
     * @return {Array} toggleGroupLevels Array that contains every toggle group level of a certain toggle group
     */
    ...
    var toggleSlavesToState = function(root, toggleGroupName, targetState) {
        ...
        // Toggle all other master checkboxes (e.g. parent master checkboxes) and action elements.
