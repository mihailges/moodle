...
M.form_filemanager.init = function(Y, options) {
    ...
    Y.extend(FileManagerHelper, Y.Base, {
        ...
        update_file: function(confirmed) {
            ...
            var newfilename = Y.Lang.trim(selectnode.one('.fp-saveas input[name="name"]').get('value'));
        ...
        select_file: function(node) {
            ...
            var namearr = node.fullname.split('.');
            var ext = namearr.pop();
            var name = namearr.join('');
            selectnode.one('.fp-saveas input[name="name"]').set('value', name);
            selectnode.one('.fp-saveas input[name="extension"]').set('value', ext);
