...
Feature: File types of the submission and feedback attachments can be limitted
  ...
  Scenario: Student submission attachments obey the list of allowed file types
    ...
    And I press "Update"
    And I should see "The original file extension has been modified as a part of the file name change. This action could potentially cause some side effects. Are you sure you want to change the extension from \".png\" to \".php\"?"
  ...
  Scenario: Overall feedback attachments obey the list of allowed file types
    ...
    And I press "Update"
    And I should see "The original file extension has been modified as a part of the file name change. This action could potentially cause some side effects. Are you sure you want to change the extension from \".php\" to \".png\"?"
    And I click on "OK" "button" in the ".moodle-dialogue-base[aria-hidden='false']" "css_element"
