...
var CSS = {
        ...
        DISABLEDFILTERWARNING: 'atto_h5p_disabledfiterwarning',
    ...
    TEMPLATE = '' +
            '<form class="atto_form mform" id="{{elementid}}_atto_h5p_form">' +
                '{{#if h5pFilterDisabled}}' +
                '<div style="" role="alert" class="alert alert-warning mb-1 {{CSS.DISABLEDFILTERWARNING}}">' +
                    '{{{get_string "h5pfilterdisabled" component}}}' +
                '</div>' +
                '{{/if}}' +
    ...
    _getDialogueContent: function() {
        ...
        var template = Y.Handlebars.compile(TEMPLATE),
            content = Y.Node.create(template({
                ...
                h5pFilterDisabled: this.get('h5pfilterdisabled')
            }));
