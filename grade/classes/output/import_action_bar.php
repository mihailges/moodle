...
class import_action_bar extends action_bar {
     ...
     */
    public function __construct(int $courseid, moodle_url $importactiveurl, string $activeplugin) {
    ...
    public function export_for_template(\renderer_base $output): array {
        ...
        $generalnavselector = new general_action_bar($this->courseid,
            new moodle_url('/grade/import/index.php', ['id' => $this->courseid]), 'import', $this->activeplugin);
        ...
        if (!$imports = \grade_helper::get_plugins_import($this->courseid)) {
            return $data;
        }
