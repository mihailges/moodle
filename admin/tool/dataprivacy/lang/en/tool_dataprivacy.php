...
$string['confirmbulkdeleterequest'] = 'Are you sure you want to create a delete data request for the user {$a}?';
...
$string['requestbulkdelete'] = 'Request user data deletion (tool_dataprivacy)';
