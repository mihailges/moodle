...
function xmldb_main_upgrade($oldversion) {
    ...
    if ($oldversion < 2018111300.01) {
        // Update favorited courses, so they are saved in the particular course context instead of the system.
        $favoritedcourses = $DB->get_records('favourite', ['component' => 'core_course', 'itemtype' => 'courses']);

        foreach ($favoritedcourses as $fc) {
