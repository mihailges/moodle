...
Feature: Book activity chapter visibility management
  ...
  Scenario: Show/hide chapters and subchapters
    ...
    And I follow "Test book"
    Then the "class" attribute of "a[title='Second chapter']" "css_element" should contain "text-muted"
    And the "class" attribute of "a[title='Third chapter']" "css_element" should contain "text-muted"
    And I follow "Next"
