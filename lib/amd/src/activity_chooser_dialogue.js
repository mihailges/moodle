...
define(
    ...
    var displayChooser = function(e, sectionid) {
        ...
        thisevent = $(".option").on('keyup', function(e) {
            // console.log(this);
            // console.log(options);
            //checkOptions();
            ...
            if (e.keyCode === 39) {
                var next = index + 1;
                var nextOption = options[next];
                $(nextOption).attr('tabindex', 0);
                $(nextOption).focus();
            ...
            if (e.keyCode === 37) {
                var prev = index - 1;
                var prevOption = options[prev];
                $(prevOption).attr('tabindex', 0);
                $(prevOption).focus();
                $(this).attr('tabindex', -1);
            }

            if (e.keyCode === 13) {
                var modanchor = $(this).find('.modicon a');
