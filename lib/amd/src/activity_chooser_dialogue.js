...
define(
    ...
    var displayChooser = function(e, sectionid) {
        ...
        var anchors = dialogue.find('.option .modicon a');
        ...
        thisevent = $('.info i').on('click', function(e) {
            setTimeout(function() {
                ...
                console.log(css);
                console.log($(e.target).parent('.info'));
                console.log($(e.target).closest('label').find('.typesummary'));
                //console.log($(infoEl).parent('span.info').siblings('span.typesummary'));
                $(e.target).closest('label').find('.typesummary').css(css).addClass('open');
            }, 100);
        });
