...
/**
 * Repository root content browser unit tests.
 *
...
/**
 * Tests for the repository root browser class.
 *
 * @package    repository_googledocs
 * @copyright  2021 Mihail Geshoski <mihail@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class repository_googledocs_root_browser_testcase extends googledocs_content_testcase {
    ...
    public function test_get_navigation(string $nodepath, array $expected) {
        ...
        $rootbrowser = new googledocs_root_content($servicemock, $nodepath);
        $navigation = $rootbrowser->get_navigation();
