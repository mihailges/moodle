...
require_once($CFG->dirroot.'/mod/lesson/tool/print/locallib.php');
...
$PAGE->set_url('/mod/lesson/tool/print/index.php', array('id'=>$cm->id));

$renderer = $PAGE->get_renderer('lessontool_print');
$page = new lessontool_print\output\print_lesson_page($lesson);
