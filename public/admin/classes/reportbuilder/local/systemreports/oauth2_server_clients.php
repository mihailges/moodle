...
class oauth2_server_clients extends system_report {
    ...
    protected function add_columns(): void {
        ...
        $this->add_column((new column(
            ...
            ->add_fields('client.id, client.name, client.clientidentifier, client.status')
            ->set_is_sortable(false)
    ...
    protected function add_filters(): void {
        ...
        $this->add_filter((new filter(
            ...
            ->add_joins($this->get_joins())
            ->set_options([
                client_entity::STATUS_ACTIVE => get_string('oauth2server_clientstatusactive', 'admin'),
                client_entity::STATUS_REVOKED => get_string('oauth2server_clientstatusrevoked', 'admin'),
            ])
        );
    }
}
