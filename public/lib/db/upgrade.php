...
function xmldb_main_upgrade($oldversion) {
    ...
    if ($oldversion < 2026062400.01) {
        ...
        $table->add_field('id', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, XMLDB_SEQUENCE, null);
        $table->add_field('clientidentifier', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, null, null);
        ...
        $table->add_key('primary', XMLDB_KEY_PRIMARY, ['id']);
        $table->add_key('clientidentifier_fk', XMLDB_KEY_FOREIGN, ['clientidentifier'], 'oauth2_server_clients', ['clientidentifier']);
        ...
        $table->add_field('accesstokenid', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, null, null);
        ...
        $table->add_key('accesstoken_fk', XMLDB_KEY_FOREIGN, ['accesstokenid'], 'oauth2_server_client_access_tokens', ['id']);
        ...
        $table->add_key('primary', XMLDB_KEY_PRIMARY, ['id']);
        $table->add_key('identifier_uk', XMLDB_KEY_UNIQUE, ['identifier']);
        $table->add_key('user_fk', XMLDB_KEY_FOREIGN, ['userid'], 'users', ['id']);
        $table->add_key('clientidentifier_fk', XMLDB_KEY_FOREIGN, ['clientidentifier'], 'oauth2_server_clients', ['clientidentifier']);
