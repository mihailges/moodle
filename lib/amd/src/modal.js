...
define([
    ...
    /**
     * Set this modal to be vertically centered on the page or not.
     *
     * @method setVerticallyCentered
     * @param {bool} value Whether the modal is vertically centered on the page or not
     */
    Modal.prototype.setVerticallyCentered = function(value) {
        if (!value) {
            this.getModal()[0].classList.remove('modal-dialog-centered');
            return;
        }

        this.getModal()[0].classList.add('modal-dialog-centered');
    };
