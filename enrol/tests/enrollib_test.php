        ...
        return [
            'The teacher can un-enrol users in a course' =>
                [
                    ...
                    'results' => [
                        ...
                        // When the user has the capabilities to un-enrol users, all course enrolment data should be
                        // removed.
            ...
            'The teacher cannot un-enrol self enrolled users'  =>
                [
                    ...
                    'results' => [
                        // When the user does not have the capabilities to un-enrol self enrolled users, the data related
                        // to this enrolment method should not be removed. Everything else should be removed.
                        'Manual course enrolment instance exists' => false,
