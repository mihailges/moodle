...
final class resource_link_manager_test extends \advanced_testcase {
     ...
     * @param int $componentarg The component argument used when calling the method.
     ...
     */
    public function test_create(array $toolsettings, array $placementsettings, string $placementtypearg, string $componentarg,
            context $contextarg, ?string $expectedexception = null): void {
        $this->resetAfterTest();
        ...
        // Create a placement.
        $ltigenerator->create_placement($toolid, $placementtype->id, [
            'default_usage' => $placementsettings['default_usage'],
        ...
        $result = resource_link_manager::create($placementtypearg, $componentarg, $contextarg, $toolid);
        // Verify that a resourse_link_manager object is returned.
    ...
    public static function create_provider(): array {
        ...
        return [
            ...
            'Invalid placement state: Tool is not visible in course' => [
                [
                ...
                'core_ltix',
                \context_course::instance($SITE->id),
                'The specified placement type cannot be used at this time with this tool.',
            ],
            'Invalid placement state: Tool is pending' => [
                [
                    'coursevisible' => \core_ltix\constants::LTI_COURSEVISIBLE_PRECONFIGURED,
            ...
            'Invalid placement state: Placement is disabled for the tool' => [
                [
                    'coursevisible' => \core_ltix\constants::LTI_COURSEVISIBLE_PRECONFIGURED,
                    'state' => \core_ltix\constants::LTI_TOOL_STATE_CONFIGURED,
                ],
            ...
            'Valid arguments and placement state provided' => [
                [
                    'coursevisible' => \core_ltix\constants::LTI_COURSEVISIBLE_PRECONFIGURED,
                    'state' => \core_ltix\constants::LTI_TOOL_STATE_CONFIGURED,
                ],
     ...
     */
    public function test_create_resource_link(array $args, array $expectedpropertyvalues): void {
        global $SITE;
        ...
        $resourcelinkmanager = resource_link_manager::create('core_ltix:validplacement', 'core_ltix',
            \context_course::instance($SITE->id), $toolid);
        ...
        $resourcelink = $resourcelinkmanager->create_resource_link(...$args);
    ...
    public function test_get_resource_link(int $itemid, bool $expectsresourcelink): void {
        ...
        $resourcelinkmanager->create_resource_link(1, 'http://example.com/tool/1/resource/1', 'Resource title');
    ...
    public function test_update_resource_link(int $itemid, array $updatedata, bool $expectedreturn,
        ...
        // Create a new resource link for the given placement type.
        $resourcelinkmanager->create_resource_link(1, 'http://example.com/tool/1/resource/1',
            'Resource title');
