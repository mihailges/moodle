...
$string['discussioncreatedon'] = 'Discussion created on {$a}';
$string['discussionsubscribed'] = 'You are subscribed to this discussion';
$string['discussionispinned'] = 'Discussion created on {$a}';
$string['discussionisnotpinned'] = 'Discussion is not pinned';
$string['discussionlastpostcreatedby'] = 'Last post in the discussion created by {$a} on {$b}';
...
$string['discussionlistsortedbycreatedasc'] = 'The discussions list is now sorted by the creation date in ascending order.';
$string['discussionlistsortedbycreateddesc'] = 'The discussions list is now sorted by the creation date in descending order.';
$string['discussionlistsortedbylastpostasc'] = 'The discussions list is now is sorted by the creation date of the last post in ascending order.';
$string['discussionlistsortedbylastpostdesc'] = 'The discussions list is now sorted by the creation date of the last post in descending order.';
$string['discussionlistsortedbyrepliesasc'] = 'The discussions list is now sorted by the number of replies in ascending order.';
$string['discussionlistsortedbyrepliesdesc'] = 'The discussions list is now sorted by the number of replies in descending order.';
...
$string['discussionnamelabel'] = 'Discussion {$a}';
$string['discussionnotsubscribed'] = 'You are not subscribed to this discussion';
...
$string['discussionstartedby'] = 'Started by {$a}';
...
$string['viewdiscussion'] = 'View discussion';
$string['viewdiscussionlastpost'] = 'View discussion\'s last post';
$string['viewdiscussionreplies'] = 'View discussion replies';
