...
EOF;
     ...
     * @param string $comboboxname The name (label) of the search combo box element. (e.g. "Search users", "Search groups").
     */
    public function i_confirm_in_search_combobox_exists($itemname, $comboboxname) {
     ...
     * @param string $comboboxname The name (label) of the search combo box element. (e.g. "Search users", "Search groups").
     */
    public function i_confirm_in_search_combobox_does_not_exist($itemname, $comboboxname) {
     ...
     * @param string $comboboxname The name (label) of the search combo box element. (e.g. "Search users", "Search groups").
     */
    public function i_click_on_in_search_combobox(string $itemname, string $comboboxname) {
