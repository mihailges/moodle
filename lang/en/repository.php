...
$string['originalextensionchange'] = 'The original file extension has been modified as a part of the file name change. This action could potentially cause some side effects. Are you sure you want to change the extension from ".{$a->originalextension}" to ".{$a->newextension}"?';
$string['originalextensionremove'] = 'The original file extension has been removed as a part of the file name change. This action could potentially cause some side effects. Are you sure you want to remove the extension ".{$a}"?';
