...
final class provider_test extends \core_privacy\tests\provider_testcase {
    ...
    public function test_get_contexts_for_userid(): void {
        ...
        \core_ltix\local\ltiservice\service_helper::update_grade($resourcelink1, $user->id, 123, 0.5);
    ...
    public function test_get_users_in_context(): void {
        ...
        \core_ltix\local\ltiservice\service_helper::update_grade($resourcelink1, $user1->id, 123, 0.5);
        \core_ltix\local\ltiservice\service_helper::update_grade($resourcelink1, $user2->id, 345, 0.8);
    ...
    public function test_export_for_context_submissions(): void {
        ...
        // Create LTI submissions for user1 and user2 for the lti1 activity.
        \core_ltix\local\ltiservice\service_helper::update_grade($resourcelink1, $user1->id, 123, 0.5);
        \core_ltix\local\ltiservice\service_helper::update_grade($resourcelink1, $user1->id, 133, 0.6);
        \core_ltix\local\ltiservice\service_helper::update_grade($resourcelink1, $user2->id, 143, 0.7);
    ...
    public function test_delete_data_for_all_users_in_context(): void {
        ...
        // Create lti submissions for user1 and user2 for the lti1 activity.
        \core_ltix\local\ltiservice\service_helper::update_grade($resourcelink1, $user1->id, 123, 0.5);
        \core_ltix\local\ltiservice\service_helper::update_grade($resourcelink1, $user2->id, 133, 0.6);
        // Create lti submission for user1 for the lti2 activity.
        \core_ltix\local\ltiservice\service_helper::update_grade($resourcelink2, $user1->id, 134, 0.6);

        // Before deletion, ensure that we have 2 submissions for lti1 activity and 1 submission for lti2 activity.
        $count = $DB->count_records('lti_submission', ['ltiresourcelinkid' => $resourcelink1->get('itemid')]);
        $this->assertEquals(2, $count);
        $count = $DB->count_records('lti_submission', ['ltiresourcelinkid' => $resourcelink2->get('itemid')]);
    ...
    public function test_delete_data_for_user(): void {
        ...
        \core_ltix\local\ltiservice\service_helper::update_grade($resourcelink1, $user2->id, 133, 0.6);
        // Create lti submission for user1 for the lti2 activity.
        \core_ltix\local\ltiservice\service_helper::update_grade($resourcelink2, $user1->id, 143, 0.6);
        ...
        $count = $DB->count_records(
            'lti_submission',
            ['ltiresourcelinkid' => $resourcelink1->get('itemid'), 'userid' => $user1->id]
        );
        $this->assertEquals(0, $count);
        ...
        $count = $DB->count_records(
            'lti_submission',
            ['ltiresourcelinkid' => $resourcelink1->get('itemid'),
            'userid' => $user2->id]
        );
        $this->assertEquals(1, $count);
        ...
        $count = $DB->count_records(
            'lti_submission',
            ['ltiresourcelinkid' => $resourcelink2->get('itemid'),
            'userid' => $user1->id]
        );
        $this->assertEquals(1, $count);
    }
    ...
    public function test_delete_data_for_users(): void {
        ...
        \core_ltix\local\ltiservice\service_helper::update_grade($resourcelink, $user1->id, 123, 0.5);
        \core_ltix\local\ltiservice\service_helper::update_grade($resourcelink, $user2->id, 124, 0.6);
        \core_ltix\local\ltiservice\service_helper::update_grade($resourcelink, $user3->id, 125, 0.7);

        // Before deletion we should have 3 lti submissions for the lti1 activity.
        $count = $DB->count_records('lti_submission', ['ltiresourcelinkid' => $resourcelink->get('itemid')]);
