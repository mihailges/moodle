...
function book_add_fake_block($chapters, $chapter, $book, $cm, $edit = null) {
    ...
    $bc->content = mod_book\local\factories\renderer_factory::get_toc_renderer($book->numbering, $chapters, $cm, $edit,
        $chapter->id)->render();
...
function book_get_toc($chapters, $chapter, $book, $cm, $edit) {
    ...
    debugging('book_get_toc() is deprecated. Please use 
        mod_book\local\factories\renderer_factory::get_toc_renderer()->render().', DEBUG_DEVELOPER);

    return mod_book\local\factories\renderer_factory::get_toc_renderer($book->numbering, $chapters, $cm, $edit, $chapter)
        ->render();
}
