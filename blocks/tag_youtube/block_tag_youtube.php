...
class block_tag_youtube extends block_base {
    ...
    /**
     * Method that returns an array containing the relevant video categories where the array index represents the
     * category ID and the array value represents the category name.
     *
     * @return array The array containing the relevant video categories
     */
    public function get_categories() {
        $categories = ['0' => get_string('anycategory', 'block_tag_youtube')];
        ...
        try {
            ...
            // If failed to fetch the categories through the API call, show a debugging message.
