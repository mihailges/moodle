...
class granted_scopes_repository {
    ...
    public function get_granted_scopes_for_user(
        ...
        $scoperepository = \core\di::get(ScopeRepositoryInterface::class);

        return array_map(
            static fn(string $scope): ScopeEntityInterface => $scoperepository->getScopeEntityByIdentifier($scope),
            $scopes,
        );
    }
