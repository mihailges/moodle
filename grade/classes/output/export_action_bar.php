...
class export_action_bar extends action_bar {
     ...
     */
    public function __construct(int $courseid, moodle_url $exportactiveurl, string $activeplugin) {
    ...
    public function export_for_template(\renderer_base $output): array {
        ...
        $generalnavselector = new general_action_bar($this->courseid,
            new moodle_url('/grade/export/index.php', ['id' => $this->courseid]), 'export', $this->activeplugin);
        ...
        if (!$exports = \grade_helper::get_plugins_export($this->courseid)) {
            return $data;
        }
