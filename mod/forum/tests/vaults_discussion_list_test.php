...
class mod_forum_vaults_discussion_list_testcase extends advanced_testcase {
    ...
    public function test_get_from_forum_id() {
        ...
        $this->assertEquals([], $vault->get_from_forum_id($forum->id, true, $user->id, null, null, $vault::PAGESIZE_DEFAULT, 0));
        ...
        $summaries = array_values($vault->get_from_forum_id($forum->id, true, null, null, null, 0, 0));
        ...
        $summaries = array_values($vault->get_from_forum_id($forum->id, false, $user->id, null, null, 0, 0));
        $this->assertCount(4, $summaries);
        $this->assertEquals($hiddendiscussion->id, $summaries[0]->get_discussion()->get_id());
        $this->assertEquals($discussion3->id, $summaries[1]->get_discussion()->get_id());
        $this->assertEquals($discussion2->id, $summaries[2]->get_discussion()->get_id());
        ...
        $summaries = array_values($vault->get_from_forum_id($forum->id, true, null, null, null, 1, 0));
        $this->assertCount(1, $summaries);
        $this->assertEquals($hiddendiscussion->id, $summaries[0]->get_discussion()->get_id());

        $summaries = array_values($vault->get_from_forum_id($forum->id, true, null, null, null, 1, 1));
        $this->assertCount(1, $summaries);
        $this->assertEquals($discussion3->id, $summaries[0]->get_discussion()->get_id());

        $summaries = array_values($vault->get_from_forum_id($forum->id, true, null, null, null, 1, 2));
        $this->assertCount(1, $summaries);
        ...
        $summaries = array_values($vault->get_from_forum_id($forum->id, true, null, 'replies', 2, 0, 0));
        $this->assertCount(4, $summaries);
        $this->assertEquals($hiddendiscussion->id, $summaries[0]->get_discussion()->get_id());
        $this->assertEquals($discussion3->id, $summaries[1]->get_discussion()->get_id());
        $this->assertEquals($discussion1->id, $summaries[2]->get_discussion()->get_id());
        ...
        $summaries = array_values($vault->get_from_forum_id($forum->id, true, null, 'created', 1, 0, 0));
        $this->assertCount(4, $summaries);
        $this->assertEquals($discussion3->id, $summaries[0]->get_discussion()->get_id());
        ...
        $summaries = array_values($vault->get_from_forum_id($forum->id, true, null, 'created', 2, 0, 0));
        $this->assertCount(4, $summaries);
    ...
    public function test_get_from_forum_id_and_group_id() {
        ...
        $this->assertEquals([], $vault->get_from_forum_id($forum->id, true, true, null, null, 0, 0));
        ...
        $summaries = array_values($vault->get_from_forum_id_and_group_id($forum->id, [1, 2, 3], true, null, null, null, 0, 0));
        ...
        $summaries = array_values($vault->get_from_forum_id_and_group_id($forum->id, [1, 2, 3], false, $user->id, null, null, 0, 0));
        $this->assertCount(6, $summaries);
        $this->assertEquals($hiddengroupdiscussion->id, $summaries[0]->get_discussion()->get_id());
        $this->assertEquals($hiddendiscussion->id, $summaries[1]->get_discussion()->get_id());
        $this->assertEquals($groupdiscussion2->id, $summaries[2]->get_discussion()->get_id());
        ...
        $summaries = array_values($vault->get_from_forum_id_and_group_id($forum->id, [1, 2, 3], true, null, null, null, 1, 0));
        $this->assertCount(1, $summaries);
        $this->assertEquals($hiddengroupdiscussion->id, $summaries[0]->get_discussion()->get_id());

        $summaries = array_values($vault->get_from_forum_id_and_group_id($forum->id, [1, 2, 3], true, null, null, null, 1, 1));
        $this->assertCount(1, $summaries);
        $this->assertEquals($hiddendiscussion->id, $summaries[0]->get_discussion()->get_id());

        $summaries = array_values($vault->get_from_forum_id_and_group_id($forum->id, [1, 2, 3], true, null, null, null, 1, 2));
        $this->assertCount(1, $summaries);
        $this->assertEquals($groupdiscussion2->id, $summaries[0]->get_discussion()->get_id());

        $summaries = array_values($vault->get_from_forum_id_and_group_id($forum->id, [1, 2, 3], false, null, null, null, 0, 0));
        $this->assertCount(4, $summaries);
        $this->assertEquals($groupdiscussion2->id, $summaries[0]->get_discussion()->get_id());
        ...
        $summaries = array_values($vault->get_from_forum_id_and_group_id($forum->id, [], true, null, null, null, 0, 0));
        $this->assertCount(3, $summaries);
        $this->assertEquals($hiddendiscussion->id, $summaries[0]->get_discussion()->get_id());
        $this->assertEquals($discussion2->id, $summaries[1]->get_discussion()->get_id());
        $this->assertEquals($discussion1->id, $summaries[2]->get_discussion()->get_id());
