...
class general_action_bar extends action_bar {
     ...
     */
    public function __construct(int $courseid, moodle_url $activeurl, string $activetype, string $activeplugin) {
    ...
    private function get_action_selector(): \url_select {
        $plugininfo = grade_get_plugin_info($this->courseid, $this->activetype, $this->activeplugin);
        $menu = [];
        $viewgroup = [];
        $setupgroup = [];
        $moregroup = [];
            ...
            foreach ($plugins as $key => $plugin) {
                ...
                switch ($plugintype) {
                    ...
                    case 'letter':
                        ...
                        break;
                    case 'import':
                        $link = new moodle_url('/grade/import/index.php', ['id' => $this->courseid]);
                        ...
                        break;
                    case 'export':
                        $link = new moodle_url('/grade/export/index.php', ['id' => $this->courseid]);
