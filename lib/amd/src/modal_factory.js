...
define(['jquery', 'core/modal_events', 'core/modal_registry', 'core/modal',
    ...
    var create = function(modalConfig, triggerElement) {
        ...
        var isVerticallyCentered = modalConfig.hasOwnProperty('verticallyCentered') ?
            modalConfig.verticallyCentered : false;
        ...
        var modalPromise = createFromType(registryConf, templateContext)
            .then(function(modal) {
                ...
                modal.setVerticallyCentered(isVerticallyCentered);
