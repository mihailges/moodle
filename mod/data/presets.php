...
$allowedactions = ['view', 'select', 'download', 'delete', 'confirmdelete', 'import', 'importzip', 'finishimport',
    'export'];
...
$url = new moodle_url('/mod/data/presets.php', array('d' => $data->id));
...
//        echo $OUTPUT->heading(format_string($data->name), 2);
        ...
        $optionsno = ['d' => $data->id];
        echo $OUTPUT->confirm($strwarning, new moodle_url('/mod/data/presets.php', $optionsyes),
            new moodle_url('/mod/data/presets.php', $optionsno));
        echo $OUTPUT->footer();
        exit(0);
    ...
    echo $OUTPUT->continue_button(new moodle_url('/mod/data/presets.php', ['d' => $data->id]));
    echo $OUTPUT->footer();
    exit(0);
}
