...
class course_outcomes_action_bar extends action_bar {
    ...
    public function export_for_template(\renderer_base $output): array {
        ...
        $generalnavselector = new general_action_bar($this->courseid,
            new moodle_url('/grade/edit/outcome/course.php', ['id' => $this->courseid]), 'outcome', 'course');
        ...
        if (has_capability('moodle/grade:manageoutcomes', $context)) {
            ...
            $manageoutcomeslink = new moodle_url('/grade/edit/outcome/index.php', ['id' => $this->courseid]);
