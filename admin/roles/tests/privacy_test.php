...
class core_role_privacy_testcase extends provider_testcase {
    ...
    public function test_get_users_in_context() {
        ...
        $this->assertTrue(in_array($admin->id, $userlist2->get_userids()));
        ...
        $this->assertTrue(in_array($admin->id, $userlist3->get_userids()));
        ...
        $this->assertTrue(in_array($user2->id, $userlist4->get_userids()));
        $this->assertTrue(in_array($admin->id, $userlist4->get_userids()));
        ...
        $this->assertTrue(in_array($admin->id, $userlist6->get_userids()));
        ...
        $this->assertTrue(in_array($user1->id, $userlist7->get_userids()));
        $this->assertTrue(in_array($user2->id, $userlist7->get_userids()));
        $this->assertTrue(in_array($admin->id, $userlist7->get_userids()));
        ...
        $this->assertTrue(in_array($user1->id, $userlist8->get_userids()));
        $this->assertTrue(in_array($admin->id, $userlist8->get_userids()));
    }
    ...
    public function test_delete_data_for_users() {
        ...
        $this->assertTrue(in_array($admin->id, $userlist5->get_userids()));
        ...
        $this->assertTrue(in_array($user1->id, $userlist5->get_userids()));
