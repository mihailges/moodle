...
class generator_testcase extends advanced_testcase {
    ...
    /**
     * Test the behaviour of test_create_h5p_record(). Test whather the h5p content data is
     * properly saved in the database.
     *
     * @dataProvider test_test_create_h5p_record_provider
     * @param array $h5pdata The h5p content data
     * @param bool $expected The expected saved data
     **/
     ...
     * @param bool $contentslibrariestdata The h5p contents libraries data.
     * @param bool $expected The expected saved data.
     **/
     ...
     * @param bool $librarydependencydata The library dependency data.
     * @param bool $expected The expected saved data.
     **/
