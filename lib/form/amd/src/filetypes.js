...
define(['jquery', 'core/log', 'core/str', 'core/modal_factory', 'core/modal_events', 'core/ajax',
    ...
    FileTypes.prototype.prepareBrowserTree = function() {
        ...
        this.browserTrigger.on('click', function(e) {
            ...
            this.loadBrowserModalBody().then(function(data) {
                ...
                this.browserModal.setBody(data);
                // Set the height of the modal to be 90% of the height of the viewport.
                this.browserModal.modal[0].style.height = '90%';
                // Set the height of the modal content to fit the height of the modal.
                this.browserModal.modal[0].children[0].style.height = '100%';
                // Set the vertical overflow to 'auto' for the modal body.
                this.browserModal.body[0].style.overflowY = 'auto';
