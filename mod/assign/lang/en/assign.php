...
$string['usersubmissionnotfound'] = 'A submission submitted by <b>{$a}</b> could not be found.';
$string['usersubmissioncannotberemoved'] = 'The submission of <b>{$a}</b> cannot be removed.';
