...
$string['oauth2server_clientcallbackurimustbehttps'] = 'Callback URIs must use HTTPS (http:// is only allowed for localhost).';
$string['oauth2server_clientcallbackurimustbevalid'] = 'Must be a valid URL (e.g., https://example.com/callback).';
...
$string['oauth2server_clientcreated'] = 'The client "{$a}" has been successfully created.';
...
$string['oauth2server_clientnoactivesecretwarning'] = 'This confidential client does not have an active client secret. Generate a new client secret from the client edit page to enable authentication.';
...
$string['oauth2server_clientstatusexpired'] = 'Expired';
