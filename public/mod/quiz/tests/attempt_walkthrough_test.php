...
final class attempt_walkthrough_test extends \advanced_testcase {
     ...
     * @param bool $canpreviewquiz Whether the given user has capability to preview the quiz.
    ...
    public function test_quiz_attempt_with_random_questions_when_versions_are_deleted(
        ...
        $questions['q1v2'] = $questiongenerator->update_question($questions['q1v1'], null,
            ['name' => 'This is the latest version']);
        $questions['q2v2'] = $questiongenerator->update_question($questions['q2v1'], null,
            ['name' => 'This is the latest version']);
        ...
        if ($expectedslotfewquestions) {
            ...
            // Verify the expected exception message.
            $this->expectExceptionMessage(get_string('notenoughrandomquestions', 'quiz',
                (object) [
