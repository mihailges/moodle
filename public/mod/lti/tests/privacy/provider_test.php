...
final class provider_test extends \core_privacy\tests\provider_testcase {
    ...
    public function test_get_contexts_for_userid(): void {
        ...
        $this->create_lti_submission($resourcelink1->get('itemid'), $user->id);
    ...
    public function test_get_users_in_context(): void {
        ...
        $this->create_lti_submission($resourcelink1->get('itemid'), $user1->id);
        $this->create_lti_submission($resourcelink1->get('itemid'), $user2->id);
    ...
    public function test_delete_data_for_all_users_in_context(): void {
        ...
        $this->create_lti_submission($resourcelink2->get('itemid'), $user1->id);
    ...
    public function test_delete_data_for_users(): void {
        ...
        $this->create_lti_submission($resourcelink->get('itemid'), $user1->id);
        $this->create_lti_submission($resourcelink->get('itemid'), $user2->id);
        $this->create_lti_submission($resourcelink->get('itemid'), $user3->id);
     ...
     *
     * @param int $ltiresourcelinkid The resource link ID (itemid)
     * @param int $userid
     */
