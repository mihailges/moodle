...
/**
 * Repository folder node unit tests.
 *
...
/**
 * Tests for the repository folder node class.
 *
 * @package    repository_googledocs
 * @copyright  2021 Mihail Geshoski <mihail@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class folder_node_testcase extends repository_googledocs_testcase {
    ...
    public function create_node_array_provider(): array {
        ...
        return [
            'Google Drive folder with modified date; root path is defined.' =>
                [
            ...
            'Google Drive folder with modified date; root path is not defined.' =>
                [
                    $this->create_google_drive_folder_object('d85b21c0f86cb0', 'Folder', '01/01/21 0:30'),
                    '',
                    $this->create_folder_content_node_array('d85b21c0f86cb0', 'Folder', '', '1609432200')
                ],
            'Google Drive folder without modified date; root path is not defined.' =>
                [
