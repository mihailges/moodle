 ...
 * @param {Promise} footerPromise  The promise from the callee of the contents to place in the modal footer.
 ...
 */
export const init = (bodyPromise, footerPromise, data, searchFunc) => {
    const modal = buildModal(bodyPromise, footerPromise);
    registerListenerEvents(modal, data, searchFunc);
};
 ...
 * @param {Function} searchFunc Partially applied function we need to manage search the passed dataset.
 */
const registerListenerEvents = (modal, data, searchFunc) => {
    modal.then(modal => {
 ...
 */
const buildModal = (bodyPromise, footerPromise) => {
