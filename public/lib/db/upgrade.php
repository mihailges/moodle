...
function xmldb_main_upgrade($oldversion) {
    ...
    if ($oldversion < 2026063000.01) {
        ...
        $table->add_key('accesstokenidentifier_fk', XMLDB_KEY_FOREIGN, ['accesstokenidentifier'], 'oauth2_server_client_access_tokens', ['identifier']);
        ...
        // Main savepoint reached.
        upgrade_main_savepoint(true, 2026063000.01);
    }
