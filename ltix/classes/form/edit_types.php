...
class edit_types extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('autocomplete', 'toolplacements', get_string('lti_tool_placements', 'core_ltix'),
            $placementsoptions, ['multiple' => true]);
     ...
     * @param string $placementtype The name of the placement type.
     */
    protected function add_placement_config_elements(\MoodleQuickForm &$mform, int $placementtypeid, string $placementtype) {
        global $OUTPUT;

        $mform->addElement('header', 'placement_' . $placementtypeid, get_string('placement_' . $placementtype, 'core_ltix'));
        $mform->setExpanded('placement_' . $placementtypeid);
        $description = get_string('placement_' . $placementtype . '_desc', 'core_ltix');
        ...
        $mform->disabledIf('deep_linking_url' . $suffix, 'supports_deep_linking' . $suffix);
        ...
        $mform->disabledIf('resource_linking_url' . $suffix, 'supports_resource_linking' . $suffix);
