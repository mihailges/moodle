...
abstract class base_client_form extends moodleform {
    ...
    protected function add_redirect_uri_elements(array $redirecturis = []): void {
        ...
        $groupelements = [];
        $groupelements[] = $mform->createElement('text', 'redirecturi', '', ['size' => '50']);
     ...
     *
     * This is used by the create form. The edit form does not need it because
     * the redirect URI fields are only added when Authorization Code is enabled.
     *
     * @return void
     */
    protected function hide_redirect_uri_elements_when_auth_code_unchecked(): void {
        $mform = $this->_form;
