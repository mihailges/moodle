...
class generator_testcase extends advanced_testcase {
     ...
     **/
    public function test_generate_h5p_data_files_creation(bool $createlibraryfiles, $expected) {
        global $DB;
    ...
    /**
     * Test the behaviour of test_create_h5p_record().
     *
     * @dataProvider test_test_create_h5p_record_provider
     * @param bool $createlibraryfiles Whether to create library files on the filesystem
     * @param bool $expected The expectation whether the files have been created or not
     **/
    public function test_create_h5p_record(array $testdata, \stdClass $expected) {
        global $DB;
        ...
        $h5pid = call_user_func_array([$generator, 'create_h5p_record'], $testdata);
     ...
     * @return array
     */
    public function test_test_create_h5p_record_provider() : array {
     ...
     * @param bool $expected The expectation whether the files have been created or not
     **/
    public function test_create_contents_libraries_record(array $testdata, \stdClass $expected) {
        global $DB;
        ...
        $contentlibid = call_user_func_array([$generator, 'create_contents_libraries_record'], $testdata);
    ...
    public function test_create_contents_libraries_record_provider() : array {
        return [
            ...
            'Create h5p content library with default dependency type' => [
                [
                    1,
                    1
                ],
     ...
     * @param bool $expected The expectation whether the files have been created or not
     **/
    public function test_create_library_dependency_record(array $testdata, \stdClass $expected) {
        global $DB;
        ...
        $contentlibid = call_user_func_array([$generator, 'create_library_dependency_record'], $testdata);
